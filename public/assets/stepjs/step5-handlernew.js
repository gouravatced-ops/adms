...
const Step5Handler = (function () {
    ...
    // Debug logging
    console.log("=== Step5Handler Initialization Debug ===");
    ...
    function init() {
        ...
        if (dataElement) {
            try {
                ...
                DOCUMENT_CONFIGS.nameTransfer = window.documentTransferList || [];
                state.documentConfigs.nameTransfer = window.documentTransferList || [];
