...
@php
$defaultBadges = [
['label' => 'Total Checked', 'field' => 'verified_files_count', 'class' => 'primary', 'always' => true],
['label' => 'Total Approved', 'field' => 'approved_files_count', 'class' => 'success', 'always' => true],
['label' => 'Total Un-approved', 'field' => 'unapproved_files_count', 'class' => 'dark', 'always' => true],
];
@endphp

<div class="container-xxl flex-grow-1">
    <h6 class="py-3 mb-2">
        <span class="invert-text-white">Dashboard / Lot Files Pending for Approval</span>
    </h6>

    <div class="card mb-4">
        <h5 class="card-header bg-primary text-white bg-info">Lot Files Pending for Approval</h5>
                ...
                <table {{ $pendingfilecount > 0 ? 'id=allLotsListTable' : '' }} class="table table-striped table-bordered align-middle">
                    ...
                    <tbody>
                        ...
                        <tr @class(['table-warning'=> $item->highlighted])>
                            ...
                            <td><strong>{{ getDivisionName($item->division_id) }}</strong></td>
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-1">
                                    ...
                                    <form
                                        action="{{ route('admin.lots.dataentry.lots.approve', ['registerId' => $item->encoded_register_no]) }}"
                                        method="POST">
                                        @csrf
