...
<div class="container-xxl flex-grow-1 ">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body mt-2">
            ...
            @endphp
            <form action="{{ route('admin.propertysubtypes.update', $encode_id) }}" method="POST"
                ...
                <div class="col-md-6">
                    ...
                    <select name="ptype_id" id="ptype_id" class="form-control">
                        ...
                        <option value="{{ $type->id }}" {{ $type->id == $pcategorytype->ptype_id ? 'selected' : '' }}>{{ $type->propertyCategory->name }} --
                                    {{ $type->name }}</option>
                        @endforeach
                    </select>
                </div>
