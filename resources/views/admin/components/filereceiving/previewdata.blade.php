...
@section('admin-content')
    ...
    @php
        $allDocumentsApproved = $registration->masterDocuments->every(fn($doc) => $doc->is_approved_divisional == 1);
    @endphp
    <div class="container-xxl flex-grow-1">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body mt-2">
                    ...
                    <table class="table table-striped table-bordered align-middle">
                        ...
                        <tbody>
                            ...
                            @if (!empty($registration?->allottee_document_path))
                                <tr>
                                    <th class="bg-light" width="20%" style="color: #000000;"><strong>Document
                                            Folder</strong></th>
                                    <td colspan="8">
                            ...
                            <div class="col-3 mb-3">
                                <div class="border rounded shadow-sm h-100">
                                    ...
                                    <div class="border-top px-2 py-2 d-flex justify-content-between">
                                        ...
                                        {{-- Approve --}}
                                        <form
                                            action="{{ route('admin.lots.dataentry.file.approveMasterDocument', ['encryptedId' => encrypt($file['id'])]) }}"
                ...
                @if (
                    $registration?->masterDocuments?->count() > 0 &&
                        (auth('admin')->user()->role === 'divisional_admin' || auth('admin')->user()->role === 'approver'))
                    <h5 class="mb-3"><b>Master Document:</b></h5>
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (isset($registration?->application_day) &&
                                                    isset($registration?->application_month) &&
                                                    isset($registration?->application_year))
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped align-middle">
                                <tbody>
                                    ...
                                    <tr>
                                        <th class="bg-light">{{ ucfirst($address?->relation_type ?? 'Relation') }} PIN /
                                            PO
                                            / PS</th>
                                ...
                                <table class="table table-bordered table-striped align-middle">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $emi?->last_emi_month ?? 'N/A' }} {{ $emi?->last_emi_year ?? '' }}
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-success fw-bold">₹
                                                {{ number_format($emi?->total_paid ?? 0) }}
                                            </td>
    ...
    @endif -->
                                ...
                                <tbody>
                                    ...
                                    @if (($registration?->name_transfer_status ?? '') == 'yes' && auth('admin')->user()->role === 'council_office')
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge {{ ($registration?->is_trans_entry_completed ?? 0) == 1 ? 'bg-success' : 'bg-warning' }}">{{ ($registration?->is_trans_entry_completed ?? 0) == 1 ? 'Yes' : 'N/A' }}</span>
                                            </td>
                                        </tr>
                                    @endif
                ...
                <div class="d-flex justify-content-center gap-2 my-4 flex-wrap">
                    @if (auth('admin')->user()->role == 'approver' || auth('admin')->user()->role == 'divisional_admin')
                        <button type="button" class="btn btn-danger btn-md" data-bs-toggle="modal"
                            data-bs-target="#ApproverDataEntryModal" {{ $allDocumentsApproved ? '' : 'disabled' }}>
                            <i class="bx bx-check-shield me-1"></i>
                            APPROVE
                        </button>
                    @endif
                ...
                {{-- Approve Modal --}}
                <div class="modal fade" id="ApproverDataEntryModal" tabindex="-1"
                    aria-labelledby="ApproverDataEntryModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            <form action="{{ route('admin.lots.dataentry.file.approve', $registration?->encrypted_id) }}"
                                ...
                                <div class="modal-header bg-primary text-white" style="padding:10px !important;">
                                    <h5 class="modal-title text-white" id="ApproverDataEntryModalLabel">
                                        Approve Data Entry
                                    </h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label class="field-label">
                                            Schemes <span class="text-danger">*</span>
                                        </label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <label>
                                            <input type="radio" name="status" value="checked" checked
                                                onclick="handleStatus()"> Checked
                                        </label>

                                        <label class="ms-3">
                                            <input type="radio" name="status" value="other"
                                                onclick="handleStatus()"> Other
                                        </label>
                                    </div>
