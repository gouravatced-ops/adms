...
@section('admin-content')
    ...
    @php
        $defaultBadges = [
            ...
            ['label' => 'Missing Master', 'field' => 'total_missing_master', 'class' => 'danger', 'always' => true],
        ];
    @endphp

    <div class="container-xxl flex-grow-1">
        <h6 class="py-3 mb-2">
            <span class="invert-text-white">Dashboard / Missing Master File Lots</span>
        </h6>

        <div class="card mb-4">
            <h5 class="card-header text-white bg-info">Missing Master File Lots</h5>
                                ...
                                <tr @class(['table-warning' => $item->highlighted])>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-1">
                                            <a href="{{ route('admin.master.missing.files', [
