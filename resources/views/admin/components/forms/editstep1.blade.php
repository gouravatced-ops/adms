                ...
                <form action="{{ route('admin.schemes.store') }}" method="POST" class="row g-3 align-items-end"
                    ...
                    <div class="row g-3">
                            ...
                            <div class="row g-2">
                                <div class="col-6">
                                    <input type="text" name="allotment_no" class="form-control only-number"
                                        value="{{ old('allotment_no', $allotment_no ?? '') }}"
                                ...
                                <div class="col-4">
                                    <select name="allotment_day" class="form-select allotment-date" required>
                                        ...
                                        @for ($d = 1; $d <= 31; $d++)
                                            @php $day=str_pad($d, 2, '0' , STR_PAD_LEFT); @endphp
                                            <option value="{{ $day }}"
                                                {{ old('allotment_day', $applicant->allotment_day ?? '') == $day ? 'selected' : '' }}>
                                                {{ $day }}</option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="col-4">
                                    <select name="allotment_month" class="form-select allotment-date" required>
                                        ...
                                        @for ($m = 1; $m <= 12; $m++)
                                            @php $month=str_pad($m, 2, '0' , STR_PAD_LEFT); @endphp
                                            <option value="{{ $month }}"
                                                {{ old('allotment_month', $applicant->allotment_month ?? '') == $month ? 'selected' : '' }}>
                                                {{ $month }}</option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="col-4">
                                    <select name="allotment_year" id="allotment_year" class="form-select allotment-date"
                                        required>
                                        <option value="">YYYY</option>
                                        @for ($y = date('Y'); $y >= 1960; $y--)
                                            <option value="{{ $y }}"
                                                {{ old('allotment_year', $applicant->allotment_year ?? '') == $y ? 'selected' : '' }}>
                                                {{ $y }}</option>
                                        @endfor
                                    </select>
                                </div>
                        ...
                        <div class="col-md-3">
                            ...
                            @php
                                $categories = [
                                    ...
                                    'Govt. Servant retiring within one year' =>
                                        'Govt. Servant retiring within one year',
                            ...
                            <select name="allottee_category" class="form-select" required>
                                ...
                                @foreach ($categories as $value => $label)
                                    <option value="{{ $value }}"
                                        {{ old('allottee_category', $applicant->allottee_category ?? '') == $value ? 'selected' : '' }}>
                                        {{ $label }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="remarks_for_dob" class="form-control"
                                value="{{ old('remarks_for_dob', $applicant->remarks_for_dob ?? '') }}"
