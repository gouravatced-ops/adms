            ...
            <form action="{{ route('admin.schemes.update', $scheme->scheme_id) }}" method="POST"
                ...
                <div class="col-md-6">
                    ...
                    <select name="division_id" id="division_id"
                        ...
                        <option value="{{ $division->id }}" {{ $division->id == $scheme->division_id ? 'selected' : ''
                ...
                <div class="col-md-6">
                    ...
                    <select name="sub_division_id" id="sub_division_id" class="form-select" required>
                        ...
                        <option value="{{ $division->id }}" {{ $division->id == $scheme->sub_division_id ? 'selected' :
                            '' }}>{{ $division->name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <select name="pcategory_id" id="property_category" class="form-select" required>
                        ...
                        <option value="{{ $PropertyCategory->id }}" {{ $PropertyCategory->id == $scheme->pcategory_id ?
                            'selected' : ''
                ...
                <div class="col-md-6">
                    ...
                    <select name="p_type_id" id="property_type" class="form-select" required>
                        ...
                        <option value="{{ $ptype->id }}" {{ $ptype->id == $scheme->p_type_id ? 'selected' :
                            '' }}>{{ $ptype->name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <select name="p_sub_type_id" id="property_sub_type" class="form-select">
                        ...
                        <option value="{{ $subptype->id }}" {{ $subptype->id == $scheme->p_sub_type_id ? 'selected' :
                ...
                <div class="col-md-6">
                    ...
                    <select name="quarter_type_id" class="form-select" required>
                        ...
                        <option value="{{ $qt->quarter_id }}" {{ $qt->quarter_id == $scheme->quarter_type_id ? 'selected' : ''
                            }}>
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" class="form-control @error('scheme_name') is-invalid @enderror" id="scheme_name"
                        name="scheme_name" value="{{ old('scheme_name', $scheme->scheme_name) }}"
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('scheme_code') is-invalid @enderror" id="scheme_code"
                        name="scheme_code" value="{{ old('scheme_code', $scheme->scheme_code) }}"
                ...
                $subnames = json_decode($scheme->subnames, true);
                @endphp
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control @error(" subname.$key") is-invalid @enderror"
                        name="subname[{{ $key }}]" value="{{ old(" subname.$key", $subnames[$key] ?? '' ) }}"
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control @error('area_sqft') is-invalid @enderror"
                                id="area_sqft" name="area_sqft" value="{{ old('area_sqft', $scheme->area_sqft) }}"
                ...
                <div class="row">
                    @php
                    $dimensions = json_decode($scheme->dimensions, true);
                    @endphp
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control @error('dimensions.east') is-invalid @enderror"
                            id="dimensions_east" name="dimensions[east]"
                            value="{{ old('dimensions.east', $dimensions['east'] ?? '') }}" placeholder="e.g., 30 ft"
                            required>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control @error('dimensions.west') is-invalid @enderror"
                            id="dimensions_west" name="dimensions[west]"
                            value="{{ old('dimensions.west', $dimensions['west'] ?? '') }}" placeholder="e.g., 30 ft"
                            required>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control @error('dimensions.north') is-invalid @enderror"
                            id="dimensions_north" name="dimensions[north]"
                            value="{{ old('dimensions.north', $dimensions['north'] ?? '') }}" placeholder="e.g., 40 ft"
                            required>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control @error('dimensions.south') is-invalid @enderror"
                            id="dimensions_south" name="dimensions[south]"
                            value="{{ old('dimensions.south', $dimensions['south'] ?? '') }}" placeholder="e.g., 40 ft"
                            required>
                    ...
                    @php
                    $arms = json_decode($scheme->arms, true);
                    @endphp
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text"
                            ...
                            value="{{ old('arms.east_to_west_north_side', $arms['east_to_west_north_side'] ?? '4 ft') }}"
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text"
                            ...
                            value="{{ old('arms.east_to_west_south_side', $arms['east_to_west_south_side'] ?? '4 ft') }}"
                            placeholder="e.g., 4 ft" required>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text"
                            ...
                            value="{{ old('arms.north_to_south_east_side', $arms['north_to_south_east_side'] ?? '4 ft') }}"
                            placeholder="e.g., 4 ft" required>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text"
                            ...
                            value="{{ old('arms.north_to_south_west_side', $arms['north_to_south_west_side'] ?? '4 ft') }}"
                            placeholder="e.g., 4 ft" required>
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control @error('down_payment_percentage') is-invalid @enderror"
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        <input type="text"
                            ...
                            value="{{ old('application_deposit_percentage', $scheme->application_deposit_percentage) }}"
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        <span class="input-group-text">₹</span>
                        <input type="number" class="form-control @error('registry_time_deposit') is-invalid @enderror"
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control @error('emi_count') is-invalid @enderror" id="emi_count"
                        name="emi_count" value="{{ old('emi_count', $scheme->emi_count) }}"
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control @error('emi_amount') is-invalid @enderror" id="emi_amount"
                        name="emi_amount" value="{{ old('emi_amount', $scheme->emi_amount) }}"
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control @error('compound_interest_rate') is-invalid @enderror"
