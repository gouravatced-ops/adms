...
@section('admin-content')
    <div class="container-xxl flex-grow-1">
        <h6 class="py-3 mb-2">
            <span class="invert-text-white">Dashboard / Scheme Master / Edit Scheme Blocks</span>
        </h6>

        <div class="card mb-4">
            <h5 class="card-header text-white bg-info">
                <i class="bx bx-edit me-2"></i>Edit Scheme Blocks
            </h5>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <p class="form-control-plaintext">{{ $scheme->scheme_name }}</p>
                    ...
                    <div class="col-md-12">
                        <div class="card border-warning">
                            ...
                            <div class="card-body mt-2 shadow-sm">
                                <form id="editBlockForm" method="POST" action="{{ route('admin.schemes.store') }}">
                                    @csrf
                                    @method('PUT')
                        ...
                        <div class="col-md-12">
                            <div class="card border-success">
                                <div class="card-header bg-success">
                                    <h5 class="mb-0 text-white">
                                        <i class="bx bx-plus-circle me-2"></i>Add New Block
                                    </h5>
                                </div>
                                <div class="card-body shadow-sm">
                                    <form action="{{ route('admin.schemes.store', $scheme->scheme_id) }}" method="POST"
                                        class="row g-3" id="addBlockForm">
                                        @csrf
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" step="0.01" class="form-control"
                                                        name="new_block[area_sqft]" placeholder="Enter area"
                                                        min="1" required>
                                                    <span class="input-group-text">sq. ft.</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <label class="form-label">Property Type</label>
                                                <input type="text" class="form-control bg-light" value="Flat"
                                                    readonly>
                                                <input type="hidden" name="new_block[property_type]" value="Flat">
                                            </div>
                                            ...
                                            <div class="col-12 property-specific-fields" id="add-property-fields">
                                                ...
                                                @if (str_contains($propertyType, 'flat') || str_contains($propertyType, 'apartment'))
                                                    <div class="row mt-3">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" class="form-control"
                                                                    name="new_block[undivided_land_share]"
                                            ...
                                            <div class="col-md-3">
                                                <label class="form-label">East Side <small
                                                        class="text-danger">*</small></label>
                                                <input type="text" class="form-control"
                                                    name="new_block[dimensions][east]" placeholder="e.g., 30 ft" required>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <label class="form-label">West Side <small
                                                        class="text-danger">*</small></label>
                                                <input type="text" class="form-control"
                                                    name="new_block[dimensions][west]" placeholder="e.g., 30 ft" required>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <label class="form-label">North Side <small
                                                        class="text-danger">*</small></label>
                                                <input type="text" class="form-control"
                                                    name="new_block[dimensions][north]" placeholder="e.g., 40 ft"
                                                    required>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <label class="form-label">South Side <small
                                                        class="text-danger">*</small></label>
                                                <input type="text" class="form-control"
                                                    name="new_block[dimensions][south]" placeholder="e.g., 40 ft"
                                                    required>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <label class="form-label">East-West (North Side) <small
                                                        class="text-danger">*</small></label>
                                                <input type="text" class="form-control"
                                                    name="new_block[arms][east_west_north]" value="4 ft"
                                            ...
                                            <div class="col-md-3">
                                                <label class="form-label">East-West (South Side) <small
                                                        class="text-danger">*</small></label>
                                                <input type="text" class="form-control"
                                                    name="new_block[arms][east_west_south]" value="4 ft"
                                                    placeholder="e.g., 4 ft" required>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <label class="form-label">North-South (East Side) <small
                                                        class="text-danger">*</small></label>
                                                <input type="text" class="form-control"
                                                    name="new_block[arms][north_south_east]" value="4 ft"
                                                    placeholder="e.g., 4 ft" required>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <label class="form-label">North-South (West Side) <small
                                                        class="text-danger">*</small></label>
                                                <input type="text" class="form-control"
                                                    name="new_block[arms][north_south_west]" value="4 ft"
                                                    placeholder="e.g., 4 ft" required>
                                            </div>
