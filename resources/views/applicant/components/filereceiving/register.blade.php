...
@section('content')
    ...
    <div class="card">
        ...
        <form action="{{ route('admin.filereceving.limitset') }}" method="POST" class="form-body">
            ...
            <p class="mb-3"> Select how many files are allowed in this registration (Max 70): </p>
            <div class="field"> <label class="label required">Allowed Files</label> 
                <input type="number" name="allowed_files" id="allowed_files" class="form-control mt-2" placeholder="Enter number manually (1-70)" min="1" max="70">
            </div>
            <br>
            <div class="field">
                ...
                <select name="division_id" class="form-control mt-2" required>
