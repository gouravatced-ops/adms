                        ...
                        <div class="dynamic-section" data-index="{{ $index }}" id="section-{{ $index }}">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="field">
                                    ...
                                    <input type="text" name="allottees[{{ $index }}][remarks]"
                                        placeholder="Enter remarks (optional)" value="{{ $allottee['remarks'] ?? '' }}">
                                </div>
                            </div>
                ...
                @else
                    ...
                    <div class="dynamic-section" data-index="0" id="section-0">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="field">
                                <label class="label">Remarks</label>
                                <input type="text" name="allottees[0][remarks]"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
                ...
                fetch(endpoint, {
                    ...
                    .then(res => {
                        if (res.success) {
                            ...
                            // Store saved state and update hidden ID field
                            if (res.allottee_id) {
                                savedAllottees[index] = res.allottee_id;
                                if (allotteeIdInput) {
                                    allotteeIdInput.value = res.allottee_id;
                                }
                            }
                            ...
                            // Update button text and style for updates
                            if (saveBtn) {
                            ...
                            showNotification('File Receiving',
                                isUpdate ? 'Allottee updated successfully!' :
                                'Allottee saved successfully!',
                                'success'
                            );
                        } else {
                            throw new Error(res.message || 'Failed to save allottee.');
                        }
                    })
                    .catch(error => {
                        console.error('Error saving allottee:', error);
                        showNotification('File Receiving', error.message ||
            ...
            function showNotification(title, message, type = 'info') {
                showToast('File Receiving', message, type = 'info');
            }
