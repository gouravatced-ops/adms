                        ...
                        <div class="joint-form-grid">
                            ...
                            <div class="joint-field">
                                ...
                                <input type="text" name="joint_allottee_pan[]" class="joint-pan pan-input"
                                    value="{{ $joint['pan_number'] ?? '' }}" placeholder="ABCDE1234F (Optional)"
                                    maxlength="10">
                            </div>
                            ...
                            <div class="joint-field">
                                ...
                                <select name="joint_allottee_doc_type[]" class="joint-doc-type">
                                    ...
                                    <option value="driving_license"
                                        {{ ($joint['other_doc_type'] ?? '') == 'driving_license' ? 'selected' : '' }}>
                                        Driving License</option>
                                    <option value="passport"
                                        {{ ($joint['other_doc_type'] ?? '') == 'passport' ? 'selected' : '' }}>Passport
                                    </option>
                                    <option value="voter_id"
                                        {{ ($joint['other_doc_type'] ?? '') == 'voter_id' ? 'selected' : '' }}>Voter ID
                                    </option>
                                </select>
                            </div>
