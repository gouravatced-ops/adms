    ...
    <div class="app-shell">
        ...
        <div class="modern-card-header-new">
            <div class="header-flex">
                <div>
                    <h1 class="header-title">Name Transfer Allottee Assignment Form</h1>
                    <p class="header-subtitle">Enter details of the name transfer allottee for property transfer</p>
                </div>
        ...
        <div class="app-body">
            ...
            <div id="stepContent" class="step-content-area">
                @include('applicant.components.nametransfer.modifynt.step1')
            </div>
...
@push('scripts')
    ...
    <script>
        const StepManager = {
            config: {
                ...
                steps: {
                    1: '{{ route('nametransfer.apply.step1.update') }}',
                    2: '{{ route('nametransfer.apply.step2.save') }}',
                    3: '{{ route('nametransfer.apply.step3.save') }}',
                },
                loadStepUrl: '{{ route('nametransfer.incomplete.apply.step', ['step' => '__STEP__', 'applicantId' => '__ID__']) }}',
            ...
            init: function() {
                ...
                // Add hidden field for applicant identification
                if (this.config.applicantId) {
                    this.addApplicantIdentifier();
                }
            ...
            addApplicantIdentifier: function() {
                // Add hidden inputs for applicant identification
                if (this.config.applicantId) {
            ...
            getStepEndpoint: function(step) {
                // All steps now use the same endpoint pattern
                const endpoint = this.config.steps[step];
                console.log(`Using endpoint for step ${step}:`, endpoint);
                return endpoint;
            },
    ...
    {{-- Load Step Handlers --}}
    <script src="{{ asset('assets/stepjs/modifynt/step1-handler-nt.js') }}"></script>
    <script src="{{ asset('assets/stepjs/modifynt/step2-handler-nt.js') }}"></script>
    <script src="{{ asset('assets/stepjs/modifynt/step3-handler-nt.js') }}"></script>
@endpush
