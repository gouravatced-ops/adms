        ...
        <div class="review-table-container">
            ...
            <table class="review-table">
                <tr>
                    ...
                    <td class="value-cell">{{ $applicant->allotProFinDetail->colony_name ?? '' }}</td>
                    <td class="label-cell">Plot Number</td>
                    <td class="value-cell">{{ $applicant->allotProFinDetail->plot_number ?? '' }}</td>
                </tr>
                <tr>
                    <td class="label-cell">Area (sq.ft.)</td>
                    <td class="value-cell">{{ $applicant->allotProFinDetail->area_sqft ?? '' }}</td>
                    <td class="label-cell">Mohalla</td>
                    <td class="value-cell">{{ $applicant->allotProFinDetail->mohalla ?? '' }}</td>
                </tr>
                <tr>
                    <td class="label-cell">Post Office</td>
                    <td class="value-cell">{{ $applicant->allotProFinDetail->post_office ?? '' }}</td>
                    <td class="label-cell">Police Station</td>
                    <td class="value-cell">{{ $applicant->allotProFinDetail->police_station ?? '' }}</td>
                </tr>
                <tr>
                    <td class="label-cell">City</td>
                    <td class="value-cell">{{ $applicant->allotProFinDetail->city ?? '' }}</td>
                    <td class="label-cell">District</td>
                    <td class="value-cell">{{ getDistrictName($applicant->allotProFinDetail->district) ?? '' }}</td>
                </tr>
                <tr>
                    <td class="label-cell">State</td>
                    <td class="value-cell">{{ getStateName($applicant->allotProFinDetail->state) ?? '' }}</td>
                    <td class="label-cell">Lottery Details</td>
                    <td class="value-cell">{{ $applicant->allotProFinDetail->lottery_details ?? '' }}</td>
                </tr>
            </table>
        </div>
        ...
        <div class="review-table-container">
            ...
            <table class="review-table">
                <tr>
                    ...
                    <td class="value-cell">{{ $applicant->allotProFinDetail->north_boundary ?? '' }} ft</td>
                    <td class="label-cell">South Boundary</td>
                    <td class="value-cell">{{ $applicant->allotProFinDetail->south_boundary ?? '' }} ft</td>
                </tr>
                <tr>
                    <td class="label-cell">East Boundary</td>
                    <td class="value-cell">{{ $applicant->allotProFinDetail->east_boundary ?? '' }} ft</td>
                    <td class="label-cell">West Boundary</td>
                    <td class="value-cell">{{ $applicant->allotProFinDetail->west_boundary ?? '' }} ft</td>
                </tr>
                <tr>
                    <td class="label-cell">EW North</td>
                    <td class="value-cell">{{ $applicant->allotProFinDetail->ew_north ?? '' }} ft</td>
                    <td class="label-cell">EW South</td>
                    <td class="value-cell">{{ $applicant->allotProFinDetail->ew_south ?? '' }} ft</td>
                </tr>
                <tr>
                    <td class="label-cell">NS East</td>
                    <td class="value-cell">{{ $applicant->allotProFinDetail->ns_east ?? '' }} ft</td>
                    <td class="label-cell">NS West</td>
                    <td class="value-cell">{{ $applicant->allotProFinDetail->ns_west ?? '' }} ft</td>
                </tr>
            </table>
        </div>
    @endif
            ...
            <table class="review-table">
                <tr>
                    ...
                    <td class="value-cell">{{ $applicant->nomineesBank->nominee_prefix ?? '' }}
                        {{ $applicant->nomineesBank->nominee_name ?? '' }}</td>
                    <td class="label-cell">Relationship</td>
                    <td class="value-cell">{{ $applicant->nomineesBank->nominee_relationship ?? '' }}</td>
                </tr>
                <tr>
