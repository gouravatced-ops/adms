        ...
        <div class="stat-card card-scheme-2">
            <div class="card-content">
                <div class="stat-info">
                    ...
                    <div class="stat-number"><span class="count-animate" data-target="{{ $totalscannedFile }}">0</span>
                    </div>
                </div>
                <div class="stat-icon">
        ...
        <div class="stat-card card-scheme-5">
            <div class="card-content">
                <div class="stat-info">
                    ...
                    <div class="stat-number"><span class="count-animate" data-target="{{ $totalcheckedFile }}">0</span>
                    </div>
                </div>
                <div class="stat-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="stat-card card-scheme-6">
            <div class="card-content">
                <div class="stat-info">
                    ...
                    <div class="stat-number"><span class="count-animate" data-target="{{ $totalapprovedFile }}">0</span>
                    </div>
                </div>
                <div class="stat-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
